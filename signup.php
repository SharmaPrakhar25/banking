         ...
         if($que1)
         {
            ...
            else
            {
                 ...
                 if($query1)
                 {
                    ...
                    {
                        $_SESSION["account_number"] = $query2_r['account_number'];
                        $acc_number = $query2_r['account_number'];
                        //echo "<script>alert('".$acc_number."')</script>";
                        $query2_2 = mysqli_query($con,"INSERT into balance (account_number, balance) values ('$acc_number','1000')");
                        if($query2_2)
                        {
        ...
        <div class="wrapper-page">
            ...
            <div class="row">
                <div class="col-sm-12 text-center margin">
                    <p>Have an account? <a href="login.php" class="text-primary m-l-5"><b>Log In</b></a>
                    </p>
