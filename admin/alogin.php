...
session_start();
 ...
 if (isset($_REQUEST['login'])) 
 {
        ...
        if($query2_r = mysqli_fetch_row($query2))
        {
            //print_r($query2_r);
            $_SESSION['username'] = $email;
            echo "<script>window.location.href='http://dev.hawkscode.com.au/adam-and-company/admin/';</script>";
        }
        else
        {
        ...
        <div class="wrapper-page">
            <div class=" card-box">
                ...
                <div class="panel-body">
                    <form class="form-horizontal m-t-20"  method="post" action="alogin.php">
                        ...
                        <div class="form-group text-center m-t-40">
                            <div class="col-xs-12">
                                <button class="btn btn-info k text-uppercase waves-effect waves-light" name="login" type="submit">Log In
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="form-group m-t-30 m-b-0">
                            <div class="col-sm-12">
                                <a href="aforgot.php" class="text-dark"><i class="fa fa-lock m-r-5"></i> Forgot
                                    your password?</a>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row">
                <div class="col-sm-12 text-center margin">
                    <p>Don't have an account? <a href="asignup.php" class="text-primary m-l-5"><b>Sign Up</b></a>
                    </p>
