...
<?php 
    ...
    if(isset($_REQUEST['status'])){
        ...
        if($status == "Approved")
        {
            ...
            {
                //print_r($query1_r);
                $balance = $query1_r['balance'] + $amount;
                $query1_1 = mysqli_query($con,"Update balance set balance='$balance' where account_number='$accountnumber'");
                if($query1_1){
                    ...
                    while($query1_2_r = mysqli_fetch_array($query1_2)){
                        ...
                        $message = "Your deposit request for Account number ".$accountnumber." of Amount ".$amount." is approved. Your current balance is ".$balance;
       ...
       $query_2 = mysqli_query($con,"Update deposit set status='$status' where id='$id'");
    }
                          ...
                          <div class="card-box">
                             ...
                             <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="datatable">
                                    ...
                                    <tbody>
                                        <?php 
                                        $query = mysqli_query($con,"Select * from deposit order by id desc");
                                    ...
                                    //print_r($query_r);
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-primary btn-sm waves-effect waves-light change" 
                                                    data-id="<?php echo $query_r['id'] ;?>" data-amount="<?php echo $query_r['amount'] ;?>"
                                                    data-account_number="<?php echo $query_r['account_number'] ;?>" data-toggle="modal" data-target="#newModal">Change Status</button></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
